...
<body>
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="board">
				<div id="list">
					<form action="${pageContext.request.contextPath}/board/list3" method="post">
						...
						<tbody>
							<c:forEach items="${pMap.boardList}" var="bvo">
								<tr>
									...
									<td>
										<c:if test="${bvo.userNo eq authUser.no}">
											<a href="${pageContext.request.contextPath}/board/delete?no=${bvo.no}">[삭제]</a>
										</c:if>
									</td>
								</tr>
							</c:forEach>
					...
					<div id="paging">
						<ul>
							...
							<c:forEach begin="${pMap.startPageBtnNo}" end="${pMap.endPageBtnNo}" step="1" var="page">
								<li><a href="${pageContext.request.contextPath}/board/list3?crtPage=${page}&keyword=${pMap.keyword}">${page}</a></li>
							</c:forEach>
